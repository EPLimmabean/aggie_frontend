...
import {
  ...
  Form,
  Image,
  Placeholder, Container, Row, Col, ListGroupItem, ListGroup,
...
import {Report, Source, Tag} from "../../objectTypes";
import {editReport, setSelectedRead} from "../../app/api/reports";
import {useMutation, useQueryClient} from "@tanstack/react-query";
import TagsTypeahead from "../tag/TagsTypeahead";
import {faArrowUpRightFromSquare} from "@fortawesome/free-solid-svg-icons";
import {faEnvelopeOpen, faPlusCircle} from "@fortawesome/free-solid-svg-icons";
                ...
                <Col xs={12} md={6} xl={4}>
                  <Card>
                    <Card.Header>
                      <Form>
                        { selectedReports &&
                            <Form.Check type="checkbox" id={report._id} onChange={()=>handleSelected(report)}
            ...
            <>
              ...
              <Card.Body key={props.report._id}>
                ...
                <div className={"sourceInfo mb-2"}>
                  ...
                  <Card.Subtitle>
                    <span>{stringToDate(props.report.authoredAt).toLocaleString()}</span>
                  </Card.Subtitle>
